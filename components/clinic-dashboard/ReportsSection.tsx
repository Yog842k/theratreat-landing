...
export default function ReportsSection({ clinicData }: ReportsSectionProps) {
  return (
    <div className="space-y-6">
      <Card className="bg-white border-2 border-blue-100 shadow-lg">
        <CardHeader className="border-b-2 border-blue-100">
          <CardTitle className="text-2xl font-black text-slate-900">Analytics & Reports</CardTitle>
        </CardHeader>
        <CardContent className="p-6">
          <div className="text-center py-12">
            ...
            <p className="text-slate-500">Analytics and downloadable reports will appear here</p>
          </div>
        </CardContent>
      </Card>
    </div>
