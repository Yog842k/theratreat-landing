...
import { Brain, Heart, Users, Zap, ChevronRight, ArrowLeft, Calendar, Phone, MapPin } from "lucide-react";
...
const therapyTypes = [
  ...
  },
  {
    ...
    description: "Experiencing sadness, low energy, or lack of motivation",
    icon: Heart,
  ...
  },
  {
    ...
    description: "Struggling with family, romantic, or social relationships",
    icon: Users,
  ...
  },
  {
    id: "trauma",
    title: "Trauma & PTSD",
    description: "Dealing with past traumatic experiences or events",
    icon: Zap,
...
const questions = [
  ...
  },
  {
    ...
    options: [
      { id: "recent", title: "Less than 1 month", description: "Recent onset", icon: Calendar, color: "bg-blue-100 text-blue-600" },
      { id: "moderate", title: "1-6 months", description: "Several months", icon: Calendar, color: "bg-blue-50 text-blue-700" },
      { id: "long", title: "6+ months", description: "Long-term concern", icon: Calendar, color: "bg-blue-100 text-blue-500" },
    ] as Option[],
  },
  {
    id: 3,
    question: "What type of session do you prefer?",
    options: [
